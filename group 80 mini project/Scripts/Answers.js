...
EnglishAnswers = [
	...
	// /What) (.*)/
	["I have nothing doing today.",
	"I will be going to work this morning.",
    "I am off for a walk",
	"I have a class to attend this afternoon."],
	...
	// /(Nice day|Bye|Good bye|Good day)/
...
FrançaisAnythingAnswers = [
	// /(.*)\?/
	["Pourquoi tu demandes ça?",
	"Considérez que vous pouvez répondre à votre propre question.",
	"Cela implique-t-il votre vie ?",
	"Pourquoi ne me dites-vous pas quelque chose que vous avez dans ma base de données ?"],

	// /(.*)/
	["Dis m'en plus.",
	"Changeons d'orientation... Parlez-moi de votre famille.",
	"Pouvez-vous élaborer davantage?",
	"Pourquoi dites vous cela?",
	"Je vois.",
	"Très intéressant.",
	"Je vois. De quoi parle-t-il ?",
	"Comment cela vous fait-il sentir?",
	"Comment vous sentez-vous quand vous dites cela ?",
	"Désolé ce n'est pas dans ma base de données"]
]